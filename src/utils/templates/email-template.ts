...
export default (contentHeader: string, message: string, redirectLink: string, btnText: string, footer = DEFAULT) => {
  return `
  <html>
  <head>
    <meta charset="utf-8">
                  ...
                  <tr>
                    <td align="center" bgcolor="#ffffff" style="padding: 12px;">
                      <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td align="center" bgcolor="#5935D5" style="border-radius: 6px;">
                            <a href="${redirectLink}" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">${btnText}</a>
                          </td>
                        </tr>
                      </table>
                    </td>
